...
enum llm_tensor {
    ...
    // Kimi-K3's full-rank KDA forget gate adds a second low-rank projection;
    // its three split convolution tensors are declared with the other SSM
    // convolution tensors above.
    LLM_TENSOR_SSM_F_A,
    LLM_TENSOR_SSM_F_B,
    LLM_TENSOR_SSM_G_A,
    LLM_TENSOR_SSM_F,
